...
ylabel('probability')
title('geniue-imposter(PCA-bottom face)')
...
h1 = plot(jj,GG)
set([h1],'LineWidth',2)
legend({'ROC(bottom face)'},'Position',[0.7 0.5 0.05 0.05])

xlabel('rank(t)')
ylabel('Rank-t identification rate(%)')
title('CMC(PCA-bottom face)')
