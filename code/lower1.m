...
xlabel('score')
ylabel('probability')
title('geniue-imposter(bottom part)')
legend({'genuine','imposter'},'Position',[0.3 0.6 0.05 0.05])
...
title('CMC(bottom part)')
set([h1],'LineWidth',2)
legend({'ROC(bottom part)'},'Position',[0.7 0.5 0.05 0.05])