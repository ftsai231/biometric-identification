...
addpath(genpath('F:\University of Florida\first year 2\Biometric identification\HW\HW5\iris-img\iris_img\probe'));


for i = 1:100
matFilename = sprintf('probe_%d.tiff',i);
[template_p{i,1}, mask_p{i,1}] = createiristemplate(matFilename);
end



function [template_p, mask_p] = createiristemplate(eyeimage_filename)

% path for writing diagnostic images
global DIAGPATH
DIAGPATH = 'F:\University of Florida\first year 2\Biometric identification\HW\HW5\data\probe';
...
[template_p mask_p] = encode(polar_array, noise_array, nscales, minWaveLength, mult, sigmaOnf); 
end
