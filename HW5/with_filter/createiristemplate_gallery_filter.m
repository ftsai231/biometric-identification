...
for i = 1:100
matFilename = sprintf('gallery_%d.tiff',i);
[template_g_f{i,1}, mask_g_f{i,1}] = createiristemplate(matFilename);
end

function [template_g_f, mask_g_f] = createiristemplate(eyeimage_filename)

% path for writing diagnostic images
global DIAGPATH
DIAGPATH = 'F:\University of Florida\first year 2\Biometric identification\HW\HW5\with_filter\image\gallery_filter';
...
[template_g_f mask_g_f] = encode(polar_array, noise_array, nscales, minWaveLength, mult, sigmaOnf); 
end
